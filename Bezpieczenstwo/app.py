...
from forms import RegisterForm, LoginForm, ChangePassword, FormAddPassword, FormSharePassword, FormResetPassword
from PasswordFeatures import make_salt, PEPPER, NUM_OF_ITER, is_password_strong_entropy
from AESCipher import encrypt, decrypt
from flask_wtf.csrf import CSRFProtect
from flask_mail import Mail, Message
from models import User, Password, UserPassword
...
app.config['MAIL_USERNAME'] = os.environ['LOGIN']
...
if __name__ == "__main__":
    app.run(ssl_context=('./my_certs/server.crt', './my_certs/server.key'))
